...
@Data
public class DetailResponseDTO<E> {
    // 검색 결과의 데이터 리스트
    ...
    @Builder(builderMethodName = "withAllDetail")
    public DetailResponseDTO(List<E> dtoList, PageRequestDTO pageRequestDTO, long totalCount, long totalEliment) {
        // 검색 결과 리스트를 초기화
    ...
    public DetailResponseDTO(List<E> dtoList, long totalCount) {
        this.dtoList = dtoList;
        this.totalCount = (int)totalCount;
    }
